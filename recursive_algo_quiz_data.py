recursive_algo_questions = [
    {
        ...
        "options": ["An algorithm that never terminates", "An algorithm that calls itself", "An algorithm that only uses loops", "An algorithm that avoids function calls"],
    ...
    },
    {
        ...
        "options": ["The case where the algorithm starts", "The case where the algorithm ends", "The case where the algorithm calls itself", "The case where the algorithm throws an error"],
    ...
    },
    {
        ...
        "options": ["It will run faster", "It will use less memory", "It may cause a stack overflow", "It will automatically find a base case"],
    ...
    },
    {
        ...
        "options": ["A recursion that never ends", "A recursion where the recursive call is the last operation", "A recursion that uses multiple base cases", "A recursion that doesn't use a base case"],
    ...
    },
    {
        ...
        "options": ["Tree traversal", "Sorting algorithms", "Calculating factorials", "Linear search"],
    ...
    },
    {
        ...
        "options": ["Always faster than iteration", "Uses less memory", "Can solve problems with a simpler and cleaner code", "Avoids the use of functions"],
    ...
    },
    {
        ...
        "options": ["Recursion elimination", "Stack simulation", "Iteration conversion", "Tail call optimization"],
    ...
    },
    {
        ...
        "options": ["Finding the maximum element in an array", "Calculating the sum of an array", "Traversing a binary tree", "Implementing a queue"],
    ...
    },
    {
        ...
        "options": ["A technique to reduce memory usage", "A method to eliminate recursion", "A way to store results of expensive function calls", "A process to optimize tail recursion"],
    ...
    },
    {
        ...
        "options": ["They are unrelated concepts", "Recursion is used to prove induction", "Induction is used to prove the correctness of recursive algorithms", "Recursion and induction are the same thing"],
    ...
    },
    {
        ...
        "options": ["Increased memory usage due to the call stack", "Potential for stack overflow", "Slower execution compared to iterative versions", "Difficulty in solving problems with a recursive nature"],
    ...
    },
    {
        ...
        "options": ["To end the recursion", "To make the problem smaller", "To increase efficiency", "To avoid using loops"],
    ...
    },
    {
        ...
        "options": ["It always leads to infinite recursion", "It involves two or more functions calling each other", "It's more efficient than simple recursion", "It's only used in functional programming"],
    ...
    },
    {
        ...
        "options": ["factorial(0) = 1", "factorial(1) = 1", "factorial(2) = 2", "All of the above are valid"],
    ...
    },
    {
        ...
        "options": ["Direct recursion is more efficient", "Indirect recursion involves multiple functions", "Direct recursion always leads to infinite loops", "Indirect recursion uses less memory"],
    ...
    },
    {
        ...
        "options": ["Recursion doesn't use the call stack", "Each recursive call adds a new frame to the call stack", "Recursion and the call stack are unrelated", "The call stack is only used in iterative algorithms"],
    ...
    },
    {
        ...
        "options": ["It always reduces time complexity", "It can be optimized by some compilers to use constant stack space", "It makes the code easier to read", "It automatically handles the base case"],
    ...
    },
    {
        ...
        "options": ["Recursive algorithms always use less memory", "Iterative algorithms always use less memory", "Recursive algorithms typically use more stack memory", "Memory usage is always the same for both approaches"],
    ...
    },
    {
        ...
        "options": ["Calculating factorials", "Traversing a linked list", "Finding the greatest common divisor", "Implementing a hash table"],
    ...
    },
    {
        ...
        "options": ["Choosing the pivot element", "Handling the base case", "Managing the call stack", "Ensuring stable sorting"],
    ...
    },
    {
        ...
        "options": ["Always using global variables", "Avoiding base cases", "Tail call optimization", "Increasing the number of recursive calls"],
    ...
    },
    {
        ...
        "options": ["To sort numbers", "To find prime factors", "To calculate the GCD efficiently", "To generate random numbers"],
    ...
    },
    {
        ...
        "options": ["It's only used for sorting algorithms", "It explores all possible solutions", "It always finds the optimal solution", "It's less efficient than iterative backtracking"],
    ...
    },
    {
        ...
        "options": ["It has a base case", "It makes the problem smaller with each recursive call", "It always uses less memory than an iterative solution", "It combines solutions of subproblems"],
    ...
    },
    {
        ...
        "options": ["To solve the base case", "To combine solutions of subproblems", "To break the problem into smaller subproblems", "To optimize the algorithm"],
    ...
    },
    {
        ...
        "options": ["The total number of recursive calls", "The maximum number of recursive calls on the call stack at any time", "The time complexity of the recursive algorithm", "The number of base cases"],
    ...
    },
    {
        ...
        "options": ["It's always faster than iterative solutions", "It uses less memory", "It naturally matches the tree structure", "It's easier to parallelize"],
    ...
    },
    {
        ...
        "options": ["It has O(n) time complexity", "It is an in-place sorting algorithm", "It uses a divide-and-conquer strategy", "It performs poorly on already sorted arrays"],
    ...
    },
    {
        ...
        "options": ["It's difficult to implement", "It has exponential time complexity", "It uses too much memory", "It doesn't work for large numbers"],
    ...
    },
    {
        ...
        "options": ["Increasing the recursion depth", "Using global variables", "Memoization or dynamic programming", "Converting to iteration"],
    ...
    },
    {
        ...
        "options": ["To break the problem into subproblems", "To solve the base case", "To recursively solve smaller subproblems", "To optimize the algorithm"],
    ...
    },
    {
        ...
        "options": ["Tail call optimization", "Memoization", "Converting to iteration", "Increasing recursion depth"],
    ...
    },
    {
        ...
        "options": ["Finding the maximum element in an array", "Calculating the sum of an array", "Generating all permutations of a string", "Implementing a queue"],
    ...
    },
    {
        ...
        "options": ["It's always faster", "It uses less memory", "It can naturally handle nested structures", "It's easier to parallelize"],
    ...
    },
    {
        ...
        "options": ["They are mutually exclusive techniques", "Dynamic programming always uses recursion", "Recursion can be optimized using dynamic programming", "Dynamic programming is always faster than recursion"],
    ...
    },
    {
        ...
        "options": ["It's difficult to define the base case", "It grows too quickly for large inputs", "It requires tail recursion", "It has too many parameters"],
    ...
    },
    {
        ...
        "options": ["Fractal generation", "Ray tracing", "Texture mapping", "Scene graph traversal"],
