dynamic_programming_questions = [
    {
        ...
        "options": ["Recursion", "Iteration", "Memoization", "Backtracking"],
    ...
    },
    {
        ...
        "options": ["Sorting an array", "Finding the shortest path in a graph", "Fibonacci sequence", "Binary search"],
    ...
    },
    {
        ...
        "options": ["Longest Common Subsequence", "Quicksort", "Depth-First Search", "Binary Search"],
    ...
    },
    {
        ...
        "options": ["Time complexity", "Space complexity", "Recursion vs. Iteration", "Problem difficulty"],
    ...
    },
    {
        ...
        "options": ["Easier to implement", "More intuitive", "Better space complexity", "Faster execution"],
    ...
    },
    {
        ...
        "options": ["Always choose the greedy solution", "Optimal solutions contain optimal sub-solutions", "Always use recursion", "Minimize the number of subproblems"],
    ...
    },
    {
        ...
        "options": ["Matrix Chain Multiplication", "Longest Increasing Subsequence", "Shortest Path in a Graph", "Merge Sort"],
    ...
    },
    {
        ...
        "options": ["Sorting the input", "Defining the recurrence relation", "Using a greedy approach", "Applying divide-and-conquer"],
    ...
    },
    {
        ...
        "options": ["The shortest path between two vertices contains shortest paths between subpaths", "The longest path in a graph", "The maximum element in an array", "The median of a sorted array"],
    ...
    },
    {
        ...
        "options": ["To store the final answer", "To represent a subproblem", "To implement recursion", "To sort the input"],
    ...
    },
    {
        ...
        "options": ["Matrix Chain Multiplication", "Longest Palindromic Subsequence", "Traveling Salesman Problem", "N-Queens Problem"],
    ...
    },
    {
        ...
        "options": ["O(n)", "O(n*m)", "O(2^n)", "O(n log n)"],
    ...
    },
    {
        ...
        "options": ["Space optimization", "Tabulation", "Memoization", "Increasing problem size"],
    ...
    },
    {
        ...
        "options": ["Always faster", "Avoids stack overflow", "Uses less memory", "More readable code"],
    ...
    },
    {
        ...
        "options": ["Coin Change (unlimited coins)", "Subset Sum", "Longest Common Subsequence", "Matrix Chain Multiplication"],
    ...
    },
    {
        ...
        "options": ["O(n)", "O(n log n)", "O(n^2)", "O(m*n)"],
        "correct_answer": "O(m*n)",
    ...
    },
    {
        ...
        "options": ["Always requires sorting", "Has only one possible solution", "Exhibits optimal substructure", "Requires greedy choice at each step"],
    ...
    },
    {
        ...
        "options": ["To start the recursion", "To end the recursion", "To optimize space complexity", "To handle edge cases"],
    ...
    },
    {
        ...
        "options": ["Fibonacci sequence", "Longest Increasing Subsequence", "Edit Distance", "Coin Change"],
    ...
    },
    {
        ...
        "options": ["Identifying overlapping subproblems", "Defining the recurrence relation", "Implementing the solution", "Proving the algorithm's correctness"],
    ...
    },
    {
        ...
        "options": ["Time complexity", "Space complexity", "Continuity requirement", "Problem difficulty"],
    ...
    },
    {
        ...
        "options": ["Fibonacci sequence", "Longest Increasing Subsequence", "Knapsack problem", "Tree Diameter"],
    ...
    },
    {
        ...
        "options": ["Always faster than bottom-up", "Solves only necessary subproblems", "Uses less memory", "Easier to implement iteratively"],
    ...
    },
    {
        ...
        "options": ["Fibonacci sequence", "Traveling Salesman Problem", "Longest Increasing Subsequence", "Edit Distance"],
    ...
    },
    {
        ...
        "options": ["To define the base case", "To express larger problems in terms of smaller subproblems", "To optimize space complexity", "To implement memoization"],
    ...
    },
    {
        ...
        "options": ["Always O(n)", "Always less than the time complexity", "Can often be optimized", "Always requires 2D arrays"],
    ...
    },
    {
        ...
        "options": ["O(n)", "O(n*k)", "O(n*k^2)", "O(2^n)"],
    ...
    },
    {
        ...
        "options": ["Sequence alignment in bioinformatics", "Shortest path algorithms", "Sorting algorithms", "Resource allocation problems"],
    ...
    },
    {
        ...
        "options": ["Use of loops", "Problem-solving approach", "Time complexity", "Memoization"],
        "correct_answer": "Memoization",
    ...
    },
    {
        ...
        "options": ["High time complexity", "Difficulty in defining subproblems", "Lack of optimal substructure", "Inapplicability of memoization"],
    ...
    },
    {
        ...
        "options": ["Unrelated concepts", "Memoization causes overlapping subproblems", "Overlapping subproblems make memoization effective", "Memoization eliminates overlapping subproblems"],
    ...
    },
    {
        ...
        "options": ["Fibonacci sequence", "Longest Increasing Subsequence", "Grid Paths", "Coin Change"],
