sorting_algo_questions = [
    ...
    },
    {
        ...
        "options": ["O(n+k)", "O(n log n)", "O(n^2)", "O(k log n)"],
    ...
    },
    {
        ...
        "options": ["Stability", "In-place sorting", "Better performance on partially sorted arrays", "Lower space complexity"],
    ...
    },
    {
        ...
        "options": ["Merge Sort", "Bubble Sort", "Counting Sort", "Quick Sort"],
    ...
    },
    {
        ...
        "options": ["Merge Sort", "Quick Sort", "Timsort", "Heap Sort"],
    ...
    },
    {
        ...
        "options": ["High time complexity", "Not stable", "High space complexity", "Not in-place"],
    ...
    },
    {
        ...
        "options": ["Quick Sort", "Merge Sort", "External Merge Sort", "Heap Sort"],
    ...
    },
    {
        ...
        "options": ["O(nk)", "O(n log n)", "O(n^2)", "O(k log n)"],
        "correct_answer": "O(nk)",
    ...
    },
    {
        ...
        "options": ["Counting Sort", "Radix Sort", "Quick Sort", "Bucket Sort"],
    ...
    },
    {
        ...
        "options": ["Stability", "In-place sorting", "Better worst-case performance", "Lower average-case time complexity"],
    ...
    },
    {
        ...
        "options": ["Quick Sort", "Merge Sort", "Bucket Sort", "Heap Sort"],
        "correct_answer": "Bucket Sort",
    ...
    },
    {
        ...
        "options": ["O(n)", "O(n log n)", "O(n^2)", "Depends on the gap sequence"],
    ...
    },
    {
        ...
        "options": ["Better average-case performance", "Stability", "Guaranteed O(n log n) worst-case performance", "Lower space complexity"],
    ...
    },
    {
        ...
        "options": ["Better worst-case performance", "Stability", "In-place sorting", "Lower average-case time complexity"],
    ...
    },
    {
        ...
        "options": ["Better average-case performance", "Stability", "In-place sorting", "Lower worst-case time complexity"],
        "correct_answer": "Stability",
    ...
    },
    {
        ...
        "options": ["O(n log n)", "O(n^2)", "O(n log^2 n)", "O(n^2 / 2^p)"],
    ...
    },
    {
        ...
        "options": ["Better average-case performance", "Stability", "Fewer swaps", "Lower worst-case time complexity"],
