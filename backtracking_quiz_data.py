backtracking_questions = [
    {
        ...
        "options": ["Greedy selection", "Dynamic programming", "Exhaustive search with pruning", "Divide and conquer"],
    ...
    },
    {
        ...
        "options": ["N-Queens", "Sudoku", "Shortest Path in a Graph", "Subset Sum"],
    ...
    },
    {
        ...
        "options": ["O(n)", "O(n log n)", "O(n^2)", "O(2^n) or higher"],
    ...
    },
    {
        ...
        "options": ["Always faster", "Guaranteed optimal solution", "Space efficiency", "Pruning of search space"],
    ...
    },
    {
        ...
        "options": ["Adding constraints", "Removing solutions", "Skipping unnecessary exploration", "Optimizing the algorithm"],
    ...
    },
    {
        ...
        "options": ["Puzzle solving", "Combinatorial optimization", "Sorting algorithms", "Constraint satisfaction problems"],
    ...
    },
    {
        ...
        "options": ["Time complexity", "Space complexity", "Problem-solving approach", "Applicability"],
    ...
    },
    {
        ...
        "options": ["Terminates the program", "Moves to the next column", "Backtracks to the previous queen", "Restarts from the first queen"],
    ...
    },
    {
        ...
        "options": ["Linear nature", "Optimal substructure", "Constraints on valid solutions", "Continuous solution space"],
    ...
    },
    {
        ...
        "options": ["Choice", "Constraint", "Goal", "Optimization"],
    ...
    },
    {
        ...
        "options": ["A binary tree of all possible states", "A graph of optimal solutions", "A tree representing all possible candidates", "A list of valid solutions"],
    ...
    },
    {
        ...
        "options": ["Finding the shortest path in a graph", "Sorting an array", "Generating all permutations of a string", "Finding the maximum element in an array"],
    ...
    },
    {
        ...
        "options": ["To find the optimal solution", "To prove the existence of a solution", "To eliminate unpromising candidates", "To speed up the algorithm"],
    ...
    },
    {
        ...
        "options": ["It's always complete", "It's always optimal", "It can be represented as a tree", "It's always polynomial in size"],
    ...
    },
    {
        ...
        "options": ["A function that finds the optimal solution", "A function that checks if a partial solution can lead to a complete solution", "A function that generates all possible solutions", "A function that optimizes the algorithm's performance"],
    ...
    },
    {
        ...
        "options": ["Depth-first search nature", "Implicit constraint checking", "Guaranteed polynomial time complexity", "Solution construction in stages"],
    ...
    },
    {
        ...
        "options": ["It's not used in Backtracking", "It's used to optimize solutions", "It's used to explore the solution space", "It's used only for memory management"],
    ...
    },
    {
        ...
        "options": ["It terminates the program", "It skips to the next empty cell", "It backtracks to the previous cell", "It restarts the entire puzzle"],
    ...
    },
    {
        ...
        "options": ["They are the same algorithm", "Backtracking is a type of DFS", "DFS is a type of Backtracking", "They are unrelated algorithms"],
    ...
    },
    {
        ...
        "options": ["Time complexity", "Space complexity", "Pruning of search space", "Applicability to problems"],
        "correct_answer": "Pruning of search space",
    ...
    },
    {
        ...
        "options": ["If all queens are placed", "If the board size is correct", "If a queen can attack another queen", "If the solution is optimal"],
    ...
    },
    {
        ...
        "options": ["Maximizing memory usage", "Ensuring polynomial time complexity", "Defining clear constraints", "Avoiding recursion"],
    ...
    },
    {
        ...
        "options": ["To find the optimal solution", "To check if a partial solution is worth exploring further", "To generate all possible solutions", "To terminate the algorithm"],
    ...
    },
    {
        ...
        "options": ["Finding the shortest path in a graph", "Sorting an array", "Solving linear equations", "Generating all possible subsets of a set"],
    ...
    },
    {
        ...
        "options": ["Guaranteed optimal solution", "Linear time complexity", "Efficient space usage", "Systematic exploration of solution space"],
    ...
    },
    {
        ...
        "options": ["The final solution", "The current condition of the problem", "The optimal path", "The algorithm's efficiency"],
    ...
    },
    {
        ...
        "options": ["Forward checking", "Constraint propagation", "Iterative deepening", "Memoization"],
    ...
    },
    {
        ...
        "options": ["To choose the final solution", "To select the next variable to assign", "To determine the optimal path", "To prune the search space"],
    ...
    },
    {
        ...
        "options": ["It always finds the optimal solution", "It can be used to find all solutions", "It can determine if no solution exists", "It can be more efficient than brute force"],
    ...
    },
    {
        ...
        "options": ["Terminates the algorithm", "Skips to the next node", "Backtracks to the previous node", "Adds a new color"],
    ...
    },
    {
        ...
        "options": ["Time complexity", "Space usage", "Problem-solving approach", "Applicability"],
        "correct_answer": "Problem-solving approach",
    ...
    },
    {
        ...
        "options": ["To optimize the solution", "To check if a complete solution is reached", "To select the next variable", "To prune the search space"],
    ...
    },
    {
        ...
        "options": ["Constraints that are not explicitly stated", "Constraints that are part of the problem definition", "Constraints that are discovered during execution", "Constraints that are always satisfied"],
    ...
    },
    {
        ...
        "options": ["Depth-limited search", "Iterative deepening", "Branch and Bound", "Bubble sort"],
    ...
    },
    {
        ...
        "options": ["Backtracking based on time constraints", "Backtracking to the most recent decision point", "Backtracking in a predefined order", "Backtracking only after a certain time has passed"],
    ...
    },
    {
        ...
        "options": ["Guaranteed optimal solution", "Fast execution for all inputs", "Ability to find all possible solutions", "Low memory usage"],
    ...
    },
    {
        ...
        "options": ["A solution that can't be improved", "A state where no further progress can be made", "The final solution", "A state that violates constraints"],
    ...
    },
    {
        ...
        "options": ["Backtracking always requires recursion", "Recursion always implies Backtracking", "Backtracking often uses recursion but can be implemented iteratively", "Backtracking and recursion are unrelated concepts"],
