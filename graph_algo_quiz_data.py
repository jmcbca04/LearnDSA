graph_algo_questions = [
    ...
    },
    {
        ...
        "choices": ["O(V)", "O(E log V)", "O(V^2)", "O(E + V log V)"],
    ...
    },
    {
        ...
        "choices": ["It doesn't work on directed graphs", "It can't handle negative edge weights", "It only works on trees", "It has high space complexity"],
    ...
    },
    {
        ...
        "choices": ["Dijkstra's algorithm", "Bellman-Ford algorithm", "Kruskal's algorithm", "Floyd-Warshall algorithm"],
    ...
    },
    {
        ...
        "choices": ["O(V)", "O(E log E)", "O(V^2)", "O(E + V log V)"],
    ...
    },
    {
        ...
        "choices": ["Dijkstra's algorithm", "Bellman-Ford algorithm", "Kruskal's algorithm", "Prim's algorithm"],
    ...
    },
    {
        ...
        "choices": ["O(V)", "O(E log V)", "O(V * E)", "O(V^2)"],
        "correct_answer": "O(V * E)",
    ...
    },
    {
        ...
        "choices": ["Dijkstra's algorithm", "Bellman-Ford algorithm", "Floyd-Warshall algorithm", "A* search algorithm"],
    ...
    },
    {
        ...
        "choices": ["O(V^2)", "O(V^3)", "O(E log V)", "O(V * E)"],
    ...
    },
    {
        ...
        "choices": ["Tarjan's algorithm", "Kruskal's algorithm", "Prim's algorithm", "A* search algorithm"],
    ...
    },
    {
        ...
        "choices": ["Dijkstra's algorithm", "Ford-Fulkerson algorithm", "Kruskal's algorithm", "A* search algorithm"],
    ...
    },
    {
        ...
        "choices": ["O(V * E)", "O(E * max_flow)", "O(V^2 * E)", "O(V * E^2)"],
    ...
    },
    {
        ...
        "choices": ["Kruskal's algorithm", "Prim's algorithm", "Hungarian algorithm", "A* search algorithm"],
    ...
    },
    {
        ...
        "choices": ["O(V^2)", "O(V^3)", "O(V^4)", "O(V * E)"],
        "correct_answer": "O(V^3)",
    ...
    },
    {
        ...
        "choices": ["Dijkstra's algorithm", "Bellman-Ford algorithm", "A* search algorithm", "Floyd-Warshall algorithm"],
        "correct_answer": "Bellman-Ford algorithm",
    ...
    },
    {
        ...
        "choices": ["Lower time complexity", "Can handle negative edges", "More memory efficient", "Uses heuristics for better performance"],
    ...
    },
    {
        ...
        "choices": ["Depth-First Search", "Breadth-First Search", "Kahn's algorithm", "Prim's algorithm"],
    ...
    },
    {
        ...
        "choices": ["Depth-First Search", "Breadth-First Search", "Tarjan's off-line algorithm", "Floyd-Warshall algorithm"],
    ...
    },
    {
        ...
        "choices": ["Ford-Fulkerson algorithm", "Edmonds-Karp algorithm", "Dinic's algorithm", "Push-relabel algorithm"],
    ...
    },
    {
        ...
        "choices": ["O(V^2 * E)", "O(V^3)", "O(V * E * log(V))", "O(V * E^2)"],
    ...
    },
    {
        ...
        "choices": ["Dijkstra's algorithm", "Ford-Fulkerson algorithm", "Karger's algorithm", "Prim's algorithm"],
        "correct_answer": "Ford-Fulkerson algorithm",
    ...
    },
    {
        ...
        "choices": ["They are always equal", "Maximum flow is always greater", "Minimum cut is always greater", "They are unrelated"],
    ...
    },
    {
        ...
        "choices": ["Dijkstra's algorithm", "Bellman-Ford algorithm", "Floyd-Warshall algorithm", "Viterbi algorithm"],
    ...
    },
    {
        ...
        "choices": ["Hungarian algorithm", "Hopcroft-Karp algorithm", "Edmonds' Blossom algorithm", "Ford-Fulkerson algorithm"],
    ...
    },
    {
        ...
        "choices": ["Kosaraju's algorithm", "Tarjan's algorithm", "Floyd-Warshall algorithm", "Prim's algorithm"],
    ...
    },
    {
        ...
        "choices": ["Kruskal's algorithm", "Prim's algorithm", "Borůvka's algorithm", "Reverse-delete algorithm"],
    ...
    },
    {
        ...
        "choices": ["O(E log V)", "O(E log E)", "O(V^2)", "O(E log log V)"],
    ...
    },
    {
        ...
        "choices": ["Ford-Fulkerson algorithm", "Edmonds-Karp algorithm", "Dinic's algorithm", "Hopcroft-Karp algorithm"],
    ...
    },
    {
        ...
        "choices": ["O(V^2)", "O(E sqrt(V))", "O(V * E)", "O(V^3)"],
    ...
    },
    {
        ...
        "choices": ["Bellman-Ford algorithm", "Floyd-Warshall algorithm", "Dijkstra's algorithm", "A* search algorithm"],
    ...
    {
        "question": "What is the time complexity of Dijkstra's algorithm using a binary heap?",
        "choices": ["O(V^2)", "O(E log V)", "O(V + E)", "O(V * E)"],
    ...
    },
    {
        ...
        "choices": ["Depth-First Search", "Breadth-First Search", "Tarjan's algorithm", "Kruskal's algorithm"],
        "correct_answer": "Tarjan's algorithm",
    ...
    },
    {
        ...
        "choices": ["They are the same", "Articulation point is a vertex, bridge is an edge", "Articulation point is an edge, bridge is a vertex", "They are unrelated concepts"],
    ...
    },
    {
        ...
        "choices": ["It will crash", "It will return incorrect results", "It will detect the negative cycle", "It will run indefinitely"],
    ...
    },
    {
        ...
        "choices": ["Ford-Fulkerson algorithm", "Edmonds-Karp algorithm", "Dinic's algorithm", "All of the above"],
    ...
    },
    {
        ...
        "choices": ["O(V * E)", "O(V * E^2)", "O(V^2 * E)", "O(V^3)"],
