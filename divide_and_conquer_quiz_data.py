divide_and_conquer_questions = [
    {
        ...
        "choices": ["Solving problems iteratively", "Breaking a problem into smaller subproblems", "Using dynamic programming", "Greedy approach to problem-solving"],
    ...
    },
    {
        ...
        "choices": ["Divide", "Conquer", "Combine", "Iterate"],
    ...
    },
    {
        ...
        "choices": ["Finding the shortest path in a graph", "Matrix multiplication", "Solving linear equations", "Finding the median of a sorted array"],
    ...
    },
    {
        ...
        "choices": ["Always results in O(n) time complexity", "Simplifies complex problems", "Guarantees optimal solutions", "Reduces space complexity"],
    ...
    },
    {
        ...
        "choices": ["Karatsuba algorithm", "Euclidean algorithm", "Sieve of Eratosthenes", "Floyd-Warshall algorithm"],
    ...
    },
    {
        ...
        "choices": ["Recursive nature", "Combining solutions of subproblems", "Always improving time complexity", "Breaking problems into smaller instances"],
    ...
    },
    {
        ...
        "choices": ["The initial problem", "The final solution", "The simplest form of the problem", "The combining step"],
    ...
    },
    {
        ...
        "choices": ["Linear Search", "Jump Search", "Binary Search", "Interpolation Search"],
    ...
    },
    {
        ...
        "choices": ["Kadane's algorithm", "Floyd's algorithm", "Kruskal's algorithm", "Strassen's algorithm"],
    ...
    },
    {
        ...
        "choices": ["Dividing the problem", "Conquering subproblems", "Combining solutions", "All of the above"],
    ...
    },
    {
        ...
        "choices": ["Sorting an array", "Finding the median", "Multiplying matrices", "Finding the shortest path in a graph"],
    ...
    },
    {
        ...
        "choices": ["Always faster", "Less memory usage", "Simpler implementation", "Better parallelization"],
    ...
    },
    {
        ...
        "choices": ["Tail recursion", "Memoization", "Balanced partitioning", "Loop unrolling"],
    ...
    },
    {
        ...
        "choices": ["Combining solutions", "Breaking the problem", "Solving subproblems", "Optimizing the algorithm"],
    ...
    },
    {
        ...
        "choices": ["Breaking the problem into subproblems", "Solving the smallest subproblems", "Merging solutions of subproblems", "Optimizing the overall solution"],
    ...
    },
    {
        ...
        "choices": ["O(n)", "O(n log n)", "O(n log^2 n)", "O(n^2)"],
    ...
    },
    {
        ...
        "choices": ["Quick Select", "Merge Sort", "Binary Search approach", "Linear time algorithm"],
    ...
    },
    {
        ...
        "choices": ["Time complexity", "Space complexity", "Overlapping subproblems", "Problem division"],
    ...
    },
    {
        ...
        "choices": ["Determine the recurrence relation", "Identify the case", "Apply the formula", "Optimize the algorithm"],
    ...
    },
    {
        ...
        "choices": ["Boyer-Moore Voting Algorithm", "Quick Select", "Merge-based algorithm", "Counting Sort"],
    ...
    },
    {
        ...
        "choices": ["Reduced time complexity", "Improved space efficiency", "Better load balancing", "Simplified algorithm design"],
    ...
    },
    {
        ...
        "choices": ["Sorting algorithms", "Fast Fourier Transform", "Graph traversal", "Binary space partitioning"],
    ...
    },
    {
        ...
        "choices": ["O(n^2)", "O(n^2.8)", "O(n^3)", "O(n log n)"],
    ...
    },
    {
        ...
        "choices": ["Solving subproblems", "Combining solutions", "Breaking the problem into smaller parts", "Optimizing the algorithm"],
    ...
    },
    {
        ...
        "choices": ["Fast Fourier Transform (FFT)", "Newton's method", "Gaussian elimination", "Simplex algorithm"],
    ...
    },
    {
        ...
        "choices": ["Linear time complexity", "Constant space complexity", "Improved average-case performance", "Ability to handle higher dimensions efficiently"],
    ...
    },
    {
        ...
        "choices": ["Optimal substructure", "Overlapping subproblems", "Recursive nature", "Independent subproblems"],
        "correct_answer": "Overlapping subproblems",
    ...
    },
    {
        ...
        "choices": ["O(n)", "O(n log n)", "O(n^1.58)", "O(n^2)"],
    ...
    },
    {
        ...
        "choices": ["Line segment intersection", "Point location", "Convex hull", "All of the above"],
        "correct_answer": "All of the above",
    ...
    },
    {
        ...
        "choices": ["It uses dynamic programming", "It reduces the number of multiplications", "It uses a greedy approach", "It uses backtracking"],
    ...
    },
    {
        ...
        "choices": ["Heap Sort", "Quick Select", "Insertion Sort", "Bubble Sort"],
    ...
    },
    {
        ...
        "choices": ["Splitting the array", "Finding the pivot", "Merging sorted subarrays", "Swapping elements"],
    ...
    },
    {
        ...
        "choices": ["Improved algorithm efficiency", "Parallel processing capability", "Simplified problem-solving", "Guaranteed optimal solution"],
    ...
    },
    {
        ...
        "choices": ["They are the same thing", "Divide and Conquer always uses recursion", "Recursion always uses Divide and Conquer", "Divide and Conquer often uses recursion, but not always"],
    ...
    },
    {
        ...
        "choices": ["The problem size doesn't reduce significantly", "Subproblems are not independent", "Combining solutions is difficult", "All of the above"],
        "correct_answer": "All of the above",
    ...
    },
    {
        ...
        "choices": ["Ensuring subproblems are of equal size", "Minimizing the number of subproblems", "Creating independent subproblems", "All of the above"],
        "correct_answer": "All of the above",
    ...
    },
    {
        ...
        "choices": ["The number of subproblems created", "The size reduction of subproblems", "The method of combining solutions", "The use of recursion"],
    ...
    },
    {
        ...
        "choices": ["BLAST algorithm", "Needleman-Wunsch algorithm", "Smith-Waterman algorithm", "UPGMA algorithm"],
