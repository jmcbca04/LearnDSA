searching_algo_questions = [
    ...
    },
    {
        ...
        "choices": ["Binary Search", "Linear Search", "Interpolation Search", "Exponential Search"],
    ...
    },
    {
        ...
        "choices": ["Binary Search", "Linear Search", "Interpolation Search", "Jump Search"],
    ...
    },
    {
        ...
        "choices": ["Interpolation Search", "Jump Search", "Exponential Search", "Fibonacci Search"],
    ...
    },
    {
        ...
        "choices": ["Binary Search", "Interpolation Search", "Fibonacci Search", "Exponential Search"],
    ...
    },
    {
        ...
        "choices": ["O(1)", "O(log n)", "O(log₃ n)", "O(n)"],
        "correct_answer": "O(log₃ n)",
    ...
    },
    {
        ...
        "choices": ["Binary Search", "Linear Search", "Jump Search", "Two-pointer Search"],
    ...
    },
    {
        ...
        "choices": ["Better worst-case performance", "Better average-case performance", "Lower space complexity", "Ability to search unsorted lists"],
    ...
    },
    {
        ...
        "choices": ["Binary Search", "Linear Search", "Modified Binary Search", "Interpolation Search"],
    ...
    },
    {
        ...
        "choices": ["Binary Search", "Linear Search", "Stepwise Search", "Recursive Binary Search"],
    ...
    },
    {
        ...
        "choices": ["Binary Search", "Linear Search", "Jump Search", "Exponential Search"],
    ...
    },
    {
        ...
        "choices": ["Better worst-case performance", "Better average-case performance for uniformly distributed data", "Lower space complexity", "Ability to search unsorted lists"],
    ...
    },
    {
        ...
        "choices": ["Linear Search", "Binary Search", "Hashing", "Pattern Matching"],
    ...
    },
    {
        ...
        "choices": ["Linear Search", "Binary Search", "Jump Search", "Exponential Search"],
        "correct_answer": "Binary Search",
    ...
    },
    {
        ...
        "choices": ["Linear Search", "Binary Search", "Skip List Search", "Interpolation Search"],
    ...
    },
    {
        ...
        "choices": ["Quick Select", "Heap Select", "Merge Select", "Bubble Select"],
    ...
    },
    {
        ...
        "choices": ["Better worst-case performance", "Better performance on small datasets", "Lower space complexity", "Better cache performance"],
    ...
    },
    {
        ...
        "choices": ["Trie-based Search", "Binary Search", "Linear Search", "Hash-based Search"],
    ...
    },
    {
        ...
        "choices": ["Linear Search", "Binary Search", "Merge-based Search", "Divide and Conquer"],
    ...
    },
    {
        ...
        "choices": ["O(n)", "O(n+m)", "O(n*m)", "O(log n)"],
        "correct_answer": "O(n)",
    ...
    },
    {
        ...
        "choices": ["Linear Search", "Binary Search", "Interpolation Search", "Tree Traversal"],
        "correct_answer": "Binary Search",
    ...
    },
    {
        ...
        "choices": ["Linear Search", "Binary Search", "Boyer-Moore Voting Algorithm", "Quick Select"],
    ...
    },
    {
        ...
        "choices": ["O(1)", "O(log n)", "O(n)", "Amortized O(log n)"],
    ...
    },
    {
        ...
        "choices": ["Linear Search", "Binary Search", "Dynamic Programming", "Depth-First Search"],
    ...
    },
    {
        ...
        "choices": ["Linear Search", "Binary Search", "Newton's Method", "Interpolation Search"],
    ...
    },
    {
        ...
        "choices": ["Lower time complexity", "Lower space complexity", "Ability to handle negative weights", "More efficient for goal-directed search"],
    ...
    },
    {
        ...
        "choices": ["Linear Search", "Binary Search", "Dynamic Programming", "KMP Algorithm"],
        "correct_answer": "Dynamic Programming",
