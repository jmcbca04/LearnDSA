string_algo_questions = [
    ...
    },
    {
        ...
        "options": ["Naive algorithm", "Rabin-Karp algorithm", "KMP algorithm", "Boyer-Moore algorithm"],
    ...
    },
    {
        ...
        "options": ["KMP algorithm", "Boyer-Moore algorithm", "Rabin-Karp algorithm", "Aho-Corasick algorithm"],
    ...
    },
    {
        ...
        "options": ["KMP algorithm", "Dynamic Programming", "Rabin-Karp algorithm", "Boyer-Moore algorithm"],
    ...
    },
    {
        ...
        "options": ["Naive algorithm", "Dynamic Programming", "Manacher's algorithm", "KMP algorithm"],
    ...
    },
    {
        ...
        "options": ["Binary Search Tree", "Hash Table", "Trie", "Heap"],
        "correct_answer": "Trie",
    ...
    },
    {
        ...
        "options": ["Lower time complexity", "Simpler implementation", "Handles multiple patterns", "Works with compressed strings"],
    ...
    },
    {
        ...
        "options": ["Booth's algorithm", "KMP algorithm", "Rabin-Karp algorithm", "Boyer-Moore algorithm"],
    ...
    },
    {
        ...
        "options": ["Naive algorithm", "KMP algorithm", "Manber-Myers algorithm", "Ukkonen's algorithm"],
    ...
    },
    {
        ...
        "options": ["KMP algorithm", "Suffix Array", "Rabin-Karp algorithm", "Boyer-Moore algorithm"],
    ...
    },
    {
        ...
        "options": ["Lower time complexity", "Simpler implementation", "Handles multiple patterns", "Efficient for two-dimensional pattern matching"],
    ...
    },
    {
        ...
        "options": ["KMP algorithm", "Suffix Array", "Dynamic Programming", "Boyer-Moore algorithm"],
        "correct_answer": "Suffix Array",
    ...
    },
    {
        ...
        "options": ["O(n)", "O(n+m)", "O(n*m)", "O(n log n)"],
        "correct_answer": "O(n+m)",
    ...
    },
    {
        ...
        "options": ["KMP algorithm", "Boyer-Moore algorithm", "Rabin-Karp algorithm", "Bitap algorithm"],
    ...
    },
    {
        ...
        "options": ["O(n)", "O(m*n)", "O(m*n/w)", "O(2^m*n)"],
    ...
    },
    {
        ...
        "options": ["Binary Search Tree", "Hash Table", "Array", "Heap"],
    ...
    },
    {
        ...
        "options": ["KMP algorithm", "Booth's algorithm", "Rabin-Karp algorithm", "Boyer-Moore algorithm"],
        "correct_answer": "Booth's algorithm",
    ...
    },
    {
        ...
        "options": ["Lower space complexity", "Faster construction time", "More versatile for string operations", "Simpler implementation"],
    ...
    },
    {
        ...
        "options": ["Naive algorithm", "KMP algorithm", "Ukkonen's algorithm", "Manber-Myers algorithm"],
    ...
    },
    {
        ...
        "options": ["Pattern matching", "Data compression", "Sorting suffixes", "Palindrome detection"],
    ...
    },
    {
        ...
        "options": ["Diff tools for version control", "DNA sequence alignment", "Spell checking", "File compression"],
    ...
    },
    {
        ...
        "explanation": "The time complexity of the naive recursive algorithm for finding the Longest Common Subsequence of two strings is O(2^n). This is because for each character, we have two options: either include it in the LCS or not, leading to an exponential number of recursive calls."
    },
    {
        "question": "Which data structure is used in the implementation of the Aho-Corasick algorithm for failure links?",
        "options": ["Stack", "Queue", "Linked List", "Trie"],
        "correct_answer": "Trie",
    ...
    },
    {
        ...
        "options": ["Lower worst-case time complexity", "Simpler implementation", "Better average-case performance", "Handles multiple patterns"],
    ...
    },
    {
        ...
        "options": ["KMP algorithm", "Boyer-Moore algorithm", "Rabin-Karp algorithm", "Compressed Pattern Matching algorithms"],
    ...
    },
    {
        ...
        "options": ["Find the longest substring that reads the same forwards and backwards", "Find the longest subsequence that reads the same forwards and backwards", "Find all palindromes in a string", "Check if a string is a palindrome"],
    ...
    },
    {
        ...
        "options": ["They are unrelated problems", "LCS is a special case of Edit Distance", "Edit Distance is a special case of LCS", "They are the same problem with different names"],
    ...
    },
    {
        ...
        "options": ["Use rolling hash functions", "Preprocess the pattern to compute a failure function", "Compare characters from right to left", "Use a suffix tree for matching"],
